...
public partial class @PlayerInput: IInputActionCollection2, IDisposable
{
    ...
    private List<IFirstPersonCharacterActions> m_FirstPersonCharacterActionsCallbackInterfaces = new List<IFirstPersonCharacterActions>();
    ...
    public struct FirstPersonCharacterActions
    {
        ...
        public void AddCallbacks(IFirstPersonCharacterActions instance)
        {
            if (instance == null || m_Wrapper.m_FirstPersonCharacterActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_FirstPersonCharacterActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IFirstPersonCharacterActions instance)
        {
            @Movement.started -= instance.OnMovement;
            @Movement.performed -= instance.OnMovement;
            @Movement.canceled -= instance.OnMovement;
        ...
        public void RemoveCallbacks(IFirstPersonCharacterActions instance)
        {
            if (m_Wrapper.m_FirstPersonCharacterActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IFirstPersonCharacterActions instance)
        {
            foreach (var item in m_Wrapper.m_FirstPersonCharacterActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_FirstPersonCharacterActionsCallbackInterfaces.Clear();
